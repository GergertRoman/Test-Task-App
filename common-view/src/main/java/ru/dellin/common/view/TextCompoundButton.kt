...
import ru.dellin.common.extension.widget.attach
import ru.dellin.common.extension.widget.checkedChangeListener
import ru.dellin.common.extension.widget.getFont
import ru.dellin.common.utils.DEFAULT_STRING
import ru.dellin.common.view.TextCompoundButton.CompoundButtonType.CHECKBOX
import ru.dellin.common.view.TextCompoundButton.CompoundButtonType.RADIOBUTTON
import ru.dellin.common.view.TextCompoundButton.CompoundButtonType.SWITCH
import ru.dellin.core.android.view.base.BaseFrameLayout
...
class TextCompoundButton @JvmOverloads constructor(
  ...
  init {
    context.withStyledAttributes(attrs, R.styleable.TextCompoundButton) {
