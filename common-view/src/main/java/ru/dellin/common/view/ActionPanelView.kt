...
import ru.dellin.common.extension.widget.animationChangeColor
import ru.dellin.common.extension.widget.getColorStateList
...
class ActionPanelView @JvmOverloads constructor(
  ...
  private var negativeTextColor = Pair(
    ...
    getColorStateList(R.color.disabledActionTextColor)
  )
  ...
  init {
    context.withStyledAttributes(attrs, R.styleable.ActionPanelView) {
